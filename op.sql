...
-- selecionar o nome e o telefone de todos os clientes ou funcionarios.
-- OUTER JOIN
SELECT P.nome, telefone
FROM pessoa P LEFT OUTER JOIN telefone T ON P.cpf = T.cpf;
...
-- selecionar todos os cep(plural) das pessoas e das academias
